...
def dance():
    ...
    # 1. Move forward away from starting position
    ...
    # 3. Drive a little after the left turn
    # Go = both green
    ct.set_car_light(left_light, 0, 255, 0)
    ct.set_car_light(right_light, 0, 255, 0)
    display.show(Image.ARROW_N)
    ...
    # 4. Turn right about 180 degrees
    ...
    # 5. Drive back toward the starting position
    # Go = both green
    ct.set_car_light(left_light, 0, 255, 0)
    ct.set_car_light(right_light, 0, 255, 0)
    display.show(Image.ARROW_N)
